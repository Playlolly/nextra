      ...
      <div className="p-10">
        ...
        <div className="mt-5 sm:flex md:mt-8">
          <a
            ...
            className="flex items-center w-full justify-center px-8 py-3 font-medium text-white no-underline bg-black border border-transparent rounded-md dark:bg-white dark:text-black betterhover:dark:hover:bg-gray-300 betterhover:hover:bg-gray-700 md:py-3 md:text-lg md:px-10 md:leading-6"
          >
            Buy now $15 ↗
          </a>
        </div>
...
export const VintageVehicleGrid: FC<GridPorps> = ({ feature }) => {
  const [imageId, setImageId] = useState(1);
