...
export const Vehicles: FC = () => {
  const configVehicles = [
    {
      ...
      image: "modelSPlaid",
      imageCount: 6,
      link: "https://playlolly.tebex.io/checkout/packages/add/5030299/single",
    },
    {
      ...
      image: "modelXPlaid",
      imageCount: 6,
      link: "https://playlolly.tebex.io/checkout/packages/add/5030300/single",
    },
    {
      title: "Model 3 (2022)",
      type: "",
      ...
      image: "model3",
      imageCount: 6,
      link: "https://playlolly.tebex.io/checkout/packages/add/5064706/single",
    },
    {
      title: "Model Y (2022)",
      type: "",
      ...
      image: "modelY",
      imageCount: 6,
      link: "https://playlolly.tebex.io/checkout/packages/add/5030297/single",
    },
    {
      title: "Roadster (2022)",
      type: "",
      ...
      image: "roadster",
      imageCount: 5,
      link: "https://playlolly.tebex.io/checkout/packages/add/5064713/single",
    },
    {
      ...
      imageCount: 9,
      link: "https://playlolly.tebex.io/checkout/packages/add/5064711/single",
    },
    {
      title: "Semi (2022)",
      type: "",
      ...
      image: "semi",
      imageCount: 4,
      link: "https://playlolly.tebex.io/checkout/packages/add/5064715/single",
    },
  ];
  ...
  return (
    <div id="cars" className="bg-gray-100 dark:bg-neutral-900">
